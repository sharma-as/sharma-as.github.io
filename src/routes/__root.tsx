...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ashutosh Sharma — Mechanical Engineer (EIT) Portfolio" },
      { name: "description", content: "Portfolio of Ashutosh Sharma — Mechanical Engineer (EIT) specializing in CAD, CFD, thermal systems, and computational simulation." },
      { name: "author", content: "Ashutosh Sharma" },
      { property: "og:title", content: "Ashutosh Sharma — Mechanical Engineer (EIT)" },
      { property: "og:description", content: "CAD, CFD, thermal management, and data-driven mechanical engineering." },
